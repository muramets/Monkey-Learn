...
export const RichTextViewer = React.memo(({ content, className }: RichTextViewerProps) => {
    return (
        <div className={clsx("rich-text-viewer prose prose-invert prose-sm max-w-none text-sub font-mono text-xs leading-relaxed select-text cursor-text bg-transparent selection:bg-main/80 selection:text-text-primary", className)}>
